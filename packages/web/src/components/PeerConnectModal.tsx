...
const PeerConnectModal: React.FC<IPeerConnectModalProps> = ({
  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={onOpenChange}>
      <AlertDialog.Content maxWidth="300px" className='box-border' onEscapeKeyDown={(event) => event.preventDefault()}>
        {/* <div className='px-8'>
        ...
        <div className='flex flex-col items-center w-full pb-2'>
          <span className='mb-4 text-lg font-medium '>使用 App 扫码以建立连接</span>
